...
int main() {
    ...
    std::cout << "Event constructor working... \n";
    Event event("2021-01-19", "School", "Next Lecture");
    std::cout << "Time: " << event.timestamp << endl;
    std::cout << "Category: " << event.category << endl;
    std::cout << "Description: " << event.description << endl;
